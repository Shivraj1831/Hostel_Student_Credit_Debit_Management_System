...
<table class="table table-bordered table-striped">
				...
				<table class="table table-bordered table-striped">
				  ...
				  <tbody>
				  <?php
				  $sqltransaction = "SELECT student.*,transaction.*,staff.staff_name FROM transaction LEFT JOIN student ON student.student_id=transaction.student_id LEFT JOIN staff ON staff.staff_id=transaction.staff_id WHERE transaction.student_id='" . $_SESSION['student_id'] . "' AND transaction.transaction_status='Active' ORDER BY transaction.transaction_id,transaction.receipt_no";
