          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Debt Transaction Report</h3>
              </div>
              <!-- /.card-header -->
				...
				<table id="example1" class="table table-bordered table-striped">
				  ...
				  while($rstransaction = mysqli_fetch_array($qsqltransaction))
				  {
					...
					echo "</td>
						...
						<td>" . $rstransaction['transaction_type'] . " - ". $rstransaction['transaction_note'] . "</td>";
