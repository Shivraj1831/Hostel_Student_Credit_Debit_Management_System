...
if(isset($_POST['submit']))
{
	...
	//$receipt_no =  $rsreceipt_no['maxno'];
	//student_id transaction_date paid_amount transaction_note
	$sql ="INSERT INTO transaction(student_id, staff_id, receipt_no, transaction_type, transaction_date, transaction_amt, transaction_note, transaction_status) values('$_POST[student_id]','$_SESSION[staff_id]','$rsreceipt_no[maxno]','Credit','$_POST[transaction_date]','$_POST[paid_amount]','$_POST[transaction_note]','Active')";
	$qsql = mysqli_query($con,$sql);
	echo mysqli_error($con);
	$insid = mysqli_insert_id($con);
	echo "<script>alert('Transaction Entry done successfully...');</script>";
	echo "<script>window.location='crinvoice.php?transaction_id=$insid';</script>";
}
?>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Credit Entry <small>Enter the details</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
