...
if(isset($_POST['submit']))
{
	...
	$sql =$sql . ",student_status='$_POST[student_status]' where student_id='" . $_SESSION['student_id'] . "'";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Student Profile <small> update your Profile</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
